...
Page({
  ...
  createOrder: function() {
    ...
    wxRequest({
      url: site_url + "seckill/createOrder",
      data: request_data,
      method: 'GET',
      header: {
        'Content-Type': 'application/json'
      ...
      if (res.data.code == 1) {
        wx.showToast({
          ...
          success: function() {
            setTimeout(function() {
              wx.redirectTo({
                url: '/pages/subpay/miaosha_subpay?money=' + totalmoney + '&order_sn=' + res.data.data.order_sn + '&order_id=' + res.data.data.order_id,
              })
            }, 2000);
          }
        })
      ...
      success: function(res) {
        ...
        wxRequest({
          ...
          return wxRequest({
            ...
            return wxRequest({
              url: site_url + "seckill/PlaceOrder",
              data: {
