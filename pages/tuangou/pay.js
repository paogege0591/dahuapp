...
Page({
  ...
  cal_yunfei: function() {
    ...
    wxRequest({
      url: site_url + "freight/calculate",
      data: {
  ...
  cal_total: function() {
    ...
    for (var i in pro_msg) {
      ...
      goodsmoney += (pro_msg[i].price) * 100 * pro_msg[i].goods_num;
    ...
    totalmoney = (goodsmoney * 100 + yunfei * 100) / 100;
  ...
  createOrder: function() {
    ...
    wxRequest({
      url: site_url + "group_buying/createOrder",
      data: request_data,
      method: 'GET',
      header: {
        'Content-Type': 'application/json'
      ...
      if (res.data.code == 1) {
        wx.showToast({
          ...
          success: function() {
            setTimeout(function() {
              wx.redirectTo({
                url: '/pages/subpay/tuangou_subpay?money=' + totalmoney + '&order_sn=' + res.data.data.order_sn + '&order_id=' + res.data.data.order_id,
              })
            }, 2000);
          }
        })
      ...
      success: function(res) {
        ...
        wxRequest({
          ...
          return wxRequest({
            ...
            return wxRequest({
              url: site_url + "group_buying/PlaceOrder",
              data: {
